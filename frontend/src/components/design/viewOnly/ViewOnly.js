...
export default function ViewOnly() {
  ...
  return (
    <div className="view-only">
      <div className="view-only-head">
        <div className="view-only-head-left">
          <div className="view-only-head-logo">
            <svg
              width="80"
              height="30"
              viewBox="0 0 80 30"
          ...
          <div className="view-only-file-btn view-only-head-btn">File</div>
          <div className="view-only-access-btn view-only-head-btn">
            View Only
          </div>
        </div>
        <div className="view-only-head-right">
          <div className="view-only-project-title">
            <span className="view-only-project-name">{project.name}</span> by{" "}
            {project.user.name}
          </div>
          <div className="view-only-login-btn">Login</div>
        </div>
      </div>
      <div className="view-only-body">
        <div
          className="view-only-canvas"
          style={{
            height: `${project.canvas.height}px`,
            width: `${project.canvas.width}px`,
            background: `${project.canvas.bg_color}`,
          }}
        >
              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    textDecoration: item.text_underline ? "underline" : "none",
                  }}
                >
                  {item.text}
                </div>
